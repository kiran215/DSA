...
public class DeleteNodeInSingleLinkedList {
	...
	public static void main(String[] args) {
		DeleteNodeInSingleLinkedList isll = new DeleteNodeInSingleLinkedList();
...
//		isll.insertNodeAtGivenPosition(75, 3);
	...
	private void deleteNodeAtTheEnd() {
		if (head == null) {
			throw new IllegalArgumentException("No LL ");
		}
		if (head.next == null) {
			head = null;
		} else {
	...
	private void deleteNodeAtTheFirst() {
